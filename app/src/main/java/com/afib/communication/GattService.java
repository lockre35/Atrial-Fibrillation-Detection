...
public class GattService {
    ...
    public GattService(String bluetoothDeviceAddress, Service service, BlockingQueue<byte[]> dataQueue)
    {
...
//				               parameter.sendBroadcast(i);
    ...
    public boolean initialize() {
        ...
        if (mBluetoothManager == null) {
            mBluetoothManager = (BluetoothManager) CallingService.getSystemService(Context.BLUETOOTH_SERVICE);
            if (mBluetoothManager == null) {
    ...
    public boolean connect(final String address) {
        ...
        // autoConnect
        // parameter to false.
        mBluetoothGatt = device.connectGatt(CallingService, false, mGattCallback);
